...
namespace UBAddons.Champions.Annie
{
    internal class Annie : ChampionPlugin
    {
        ...
        private const string Passive_Buff = "pyromania";
        private const string Stun_Buff = "pyromania_particle";
        protected static int Passive_Count { get { return player.GetBuffCount(Passive_Buff); } }
        protected static bool Has_Stun { get { return player.HasBuff(Stun_Buff); } }
        ...
        protected internal static class MenuValue
        {
            ...
            internal static class LaneClear
            {
                ...
                public static bool Stop { get { return LaneClearMenu.VChecked("UBAddons.Annie.Passive.Off"); } }

                public static int Stopifhas { get { return LaneClearMenu.VSliderValue("UBAddons.Annie.Passive.Count.Buff"); } }
            ...
            {
                public static bool Stop { get { return JungleClearMenu.VChecked("UBAddons.Annie.Passive.Off"); } }
            ...
            internal static class LastHit
            {
                ...
                public static bool Stop { get { return LastHitMenu.VChecked("UBAddons.Annie.Passive.Off"); } }

                public static int Stopifhas { get { return LastHitMenu.VSliderValue("UBAddons.Annie.Passive.Count.Buff"); } }
