...
namespace UBAddons.Libs.ColorPicker
{
    public sealed class ColorPicker : ValueBase<Color>
    {
        ...
        public override bool Draw()
        {
            ...
            if (this.IsInside(this.DisplayNameText.PositionRectangle.BottomRight) && this.IsInside(this.DisplayNameText.PositionRectangle.TopLeft))
            this.DisplayNameText.Draw();

            // Color Display Bar
            this.DrawRectangle(this.ColorBarNative, DefaultColorGold, 2, false);
            if (this.IsInside(this.ColorBarNative.BottomRight) && this.IsInside(this.ColorBarNative.TopLeft))
                Line.DrawLine(
                    this.CurrentValue,
            ...
            // Red
            if (this.IsInside(this.RedBarNative.BottomRight) && this.IsInside(this.RedBarNative.TopLeft))
            {
            ...
            if (this.IsInside(this.RedText.PositionRectangle.BottomRight) && this.IsInside(this.RedText.PositionRectangle.TopLeft))
            {
                this.RedText.Draw();
            }

            // Green
            if (this.IsInside(this.GreenBarNative.BottomRight) && this.IsInside(this.GreenBarNative.TopLeft))
            {
            ...
            if (this.IsInside(this.GreenText.PositionRectangle.BottomRight) && this.IsInside(this.GreenText.PositionRectangle.TopLeft))
            {
                this.GreenText.Draw();
            }

            // Blue
            if (this.IsInside(this.BlueBarNative.BottomRight) && this.IsInside(this.BlueBarNative.TopLeft))
            {
            ...
            if (this.IsInside(this.BlueText.PositionRectangle.BottomRight) && this.IsInside(this.BlueText.PositionRectangle.TopLeft))
            {
                this.BlueText.Draw();
            }

            // Alpha
            if (this.IsInside(this.AlphaBarNative.BottomRight) && this.IsInside(this.BlueBarNative.TopLeft))
            {
            ...
            if (this.IsInside(this.AlphaText.PositionRectangle.BottomRight) && this.IsInside(this.AlphaText.PositionRectangle.TopLeft))
            {
                this.AlphaText.Draw();
            }
